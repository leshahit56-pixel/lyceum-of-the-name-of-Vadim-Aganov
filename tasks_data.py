    ...
    if lesson_id == 1:
        ...
        return [
            {'id': 1, 'lesson_id': 7, 'title': 'Список покупок', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Сначала получите от пользователя три строки (каждая с новой строки) — это названия товаров. Сохраните их в список. Потом выведите второй элемент этого списка (нумерация с нуля, то есть индекс 1).</p><p><strong>Формат ввода:</strong> Три строки с названиями товаров.</p><p><strong>Формат вывода:</strong> Второй товар.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 2, 'lesson_id': 7, 'title': 'Сумма элементов', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Пользователь вводит пять целых чисел, каждое с новой строки. Сначала считайте эти числа и положите их в список. Затем с помощью цикла for найдите сумму всех элементов списка и выведите её.</p><p><strong>Формат ввода:</strong> Пять целых чисел, каждое с новой строки.</p><p><strong>Формат вывода:</strong> Одно число — сумма.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 3, 'lesson_id': 7, 'title': 'Первый и последний', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Пользователь вводит одну строку, содержащую несколько слов, разделённых пробелами. Сначала прочитайте эту строку, затем с помощью split превратите её в список слов. Выведите первый и последний элементы этого списка через пробел.</p><p><strong>Формат ввода:</strong> Строка со словами через пробел.</p><p><strong>Формат вывода:</strong> Первое и последнее слово через пробел.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 4, 'lesson_id': 7, 'title': 'Только четные', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь сначала вводит число N — количество элементов, а затем N целых чисел (каждое с новой строки). Прочитайте все числа, сохраните их в список. Потом создайте новый список, в который попадут только чётные числа. Выведите все чётные числа через пробел.</p><p><strong>Формат ввода:</strong> Число N, затем N чисел.</p><p><strong>Формат вывода:</strong> Чётные числа через пробел.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 5, 'lesson_id': 7, 'title': 'Поиск в списке', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь вводит одну строку с числами, разделёнными пробелами. Сначала преобразуйте эту строку в список чисел. Затем пользователь вводит число X. Если X есть в списке, выведите его индекс (первый найденный). Если нет — выведите "Не нашел".</p><p><strong>Формат ввода:</strong> Строка с числами через пробел, затем число X.</p><p><strong>Формат вывода:</strong> Индекс элемента или "Не нашел".</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 6, 'lesson_id': 7, 'title': 'Средний балл', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь вводит строку с оценками через пробел. Считайте эту строку, превратите в список чисел. Найдите среднее арифметическое всех оценок и выведите его, округлив до целого числа (используйте round).</p><p><strong>Формат ввода:</strong> Числа через пробел.</p><p><strong>Формат вывода:</strong> Одно целое число — средний балл.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 7, 'lesson_id': 7, 'title': 'Разворот без среза', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Пользователь вводит строку с элементами через пробел. Превратите её в список. Используя цикл (не срез [::-1]), разверните список задом наперёд и выведите элементы в обратном порядке через пробел.</p><p><strong>Формат ввода:</strong> Элементы через пробел.</p><p><strong>Формат вывода:</strong> Элементы в обратном порядке через пробел.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 8, 'lesson_id': 7, 'title': 'Уникальные элементы', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Пользователь вводит строку с числами через пробел. Создайте из неё список. Затем найдите и выведите через пробел только те элементы, которые встречаются в списке ровно один раз.</p><p><strong>Формат ввода:</strong> Числа через пробел.</p><p><strong>Формат вывода:</strong> Уникальные числа через пробел.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 9, 'lesson_id': 7, 'title': 'Вадим Маликович и воксельный мир', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Сначала пользователь вводит число N — количество блоков. Затем N строк, каждая из которых содержит три числа через пробел: координаты x, y, z блока. Соберите все блоки в список (каждый блок — тоже список из трёх чисел). Если координата y блока отрицательная, блок считается подземным. Подсчитайте количество подземных блоков и выведите в формате "Подземных блоков: K".</p><p><strong>Формат ввода:</strong> Число N, затем N строк вида "x y z".</p><p><strong>Формат вывода:</strong> "Подземных блоков: K".</p>',
             'starter_code': '', 'status': None,
             'tests': [
        ...
        return [
            {'id': 1, 'lesson_id': 8, 'title': 'Нормализация логина', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Пользователь вводит строку, в которой могут быть лишние пробелы по краям. Считайте эту строку, удалите пробелы в начале и в конце (strip), приведите все символы к нижнему регистру (lower). Выведите очищенную строку.</p><p><strong>Формат ввода:</strong> Одна строка.</p><p><strong>Формат вывода:</strong> Очищенная строка в нижнем регистре.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 2, 'lesson_id': 8, 'title': 'Пополнение инвентаря', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Изначально у вас есть список items = ["Меч", "Щит"]. Пользователь вводит две строки: сначала новый предмет, который нужно добавить в конец списка, затем предмет, который нужно добавить в начало. Прочитайте оба предмета, выполните соответствующие операции и выведите итоговый список.</p><p><strong>Формат ввода:</strong> Две строки (новые предметы).</p><p><strong>Формат вывода:</strong> Список объектов (например, ["Карта", "Меч", "Щит", "Зелье"]).</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 3, 'lesson_id': 8, 'title': 'Статистика оценок', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Пользователь вводит пять целых чисел, каждое с новой строки. Сначала считайте их в список. Затем найдите и выведите через пробел максимальный элемент, минимальный элемент и сумму всех элементов списка.</p><p><strong>Формат ввода:</strong> Пять целых чисел, каждое с новой строки.</p><p><strong>Формат вывода:</strong> Три числа через пробел (макс, мин, сумма).</p>',
             'starter_code': '', 'status': None,
             'tests': [
                 {"input": ['85', '92', '78', '90', '88'], "expected": ['92 78 433']},
             ]},

            {'id': 4, 'lesson_id': 8, 'title': 'Анализатор тегов', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь вводит две строки: сначала текст, затем искомое слово. Приведите текст и искомое слово к нижнему регистру. Разбейте текст на список слов и подсчитайте, сколько раз встречается искомое слово (без учёта регистра). Выведите это количество.</p><p><strong>Формат ввода:</strong> Первая строка — текст, вторая — искомое слово.</p><p><strong>Формат вывода:</strong> Одно целое число.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 5, 'lesson_id': 8, 'title': 'Генератор ID документов', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь вводит целое число. Превратите его в строку, затем дополните слева нулями до длины 6 символов (zfill). Припишите в начало префикс "DOC" и выведите результат.</p><p><strong>Формат ввода:</strong> Одно целое число.</p><p><strong>Формат вывода:</strong> Строка формата DOC000000.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 6, 'lesson_id': 8, 'title': 'Управление очередью', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Пользователь вводит строку с именами, разделёнными пробелами. Сначала преобразуйте её в список. Отсортируйте список по алфавиту. Удалите из списка последнего человека (pop). Выведите итоговый список имён.</p><p><strong>Формат ввода:</strong> Строка с именами через пробел.</p><p><strong>Формат вывода:</strong> Итоговый список имён.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 7, 'lesson_id': 8, 'title': 'Поиск расширения файла', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Пользователь вводит имя файла (строку). Найдите позицию последней точки в строке. Если точка есть, выведите часть строки после неё (расширение). Если точки нет, выведите само имя файла целиком.</p><p><strong>Формат ввода:</strong> Имя файла (строка).</p><p><strong>Формат вывода:</strong> Строка расширения.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 8, 'lesson_id': 8, 'title': 'CSV-сборщик', 'points': 12, 'difficulty': 'hard',
             'description': '<p>У вас есть список из трёх строк: "192.168.1.1", "Linux", "Apache". Объедините все элементы списка в одну строку, вставляя между ними символ точки с запятой (";"). Полученную строку выведите на экран.</p><p><strong>Формат ввода:</strong> Отсутствует (исходный список уже задан).</p><p><strong>Формат вывода:</strong> Одна строка данных.</p>',
             'starter_code': '', 'status': None,
             'tests': [
            ...
            {'id': 9, 'lesson_id': 8, 'title': 'Вадим Маликович и чистка базы', 'points': 15, 'difficulty': 'hard',
             'description': '<p>Пользователь вводит строку, в которой имена разделены символом "решетка" (#). Разбейте эту строку по символу "#", получится список имён. Для каждого имени удалите лишние пробелы по краям, сделайте первую букву заглавной, а остальные строчными (title). Затем отсортируйте имена по алфавиту и выведите их через запятую с пробелом.</p><p><strong>Формат ввода:</strong> Строка с именами через "#".</p><p><strong>Формат вывода:</strong> Имена через запятую и пробел.</p>',
             'starter_code': '', 'status': None,
             'tests': [
