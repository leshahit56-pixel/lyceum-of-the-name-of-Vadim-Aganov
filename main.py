...
def lesson_operators(lesson):
    ...
    books_and_titles = {
        1: ['/book_for_first_lessonn', 'Знакомство со средой'],
        2: ['/book_for_usloviya', 'Условный Оператор'],
        3: ['/book_for_operators', 'Операторы и встроенные функции'],
        4: ['/book_for_while', 'Цикл While, флаги'],
    ...
    book_and_title = books_and_titles[les]

    progress = get_lesson_progress(les)

    lesson_info = get_tasks_for_lesson(les)
