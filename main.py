    ...
    if lesson_id == 1:
        ...
        return [
            ...
            {'id': 9, 'lesson_id': 3, 'title': 'Вадим Маликович и ручные проверки', 'points': 12, 'difficulty': 'hard',
             ...
             'tests': [
                 {"input": ['10', '200', '2'],
                  "expected": ['0o372', '200', "<class 'int'>", 'Я тебе не нейросеть, чтобы за тебя код писать.']},
                 {"input": ['5', '10', '10'], "expected": ['0o0', '10', "<class 'int'>", 'Идеально, ставлю пятёрку.']},
                 {"input": ['8', '20', '2'],
                  "expected": ['0o50', '20', "<class 'int'>", 'Ладно, проверю, но в следующий раз — нейросеть.']},
             ]},
        ]
    elif lesson_id == 4:
        return [
