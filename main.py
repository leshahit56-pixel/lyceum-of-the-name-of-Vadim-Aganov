    ...
    if lesson_id == 1:
        ...
        return [
            ...
            {'id': 3, 'lesson_id': 3, 'title': 'Расстояние от дома', 'points': 10, 'difficulty': 'easy',
             'description': '<p>Турист отмечал на карте свои перемещения: положительные числа — движение на север, отрицательные — на юг. В конце дня он записал одно итоговое число. Но ему нужно узнать, на каком расстоянии от дома (по модулю) он оказался.</p><p><strong>Формат ввода:</strong> Одно число.</p><p><strong>Формат вывода:</strong> Неотрицательное число — расстояние от нуля.</p><p><strong>Пример 1:</strong><br>Ввод:<br>-42<br>Вывод:<br>42</p><p><strong>Пример 2:</strong><br>Ввод:<br>-3.14<br>Вывод:<br>3.14</p><p><strong>Пример 3:</strong><br>Ввод:<br>15.7<br>Вывод:<br>15.7</p>',
             'starter_code': '', 'status': None},

            {'id': 4, 'lesson_id': 3, 'title': 'Инженерный калькулятор', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Инженеру нужна программа, которая выполняет одну арифметическую операцию над двумя числами.</p><p><strong>Формат ввода:</strong> Три строки: первое число, знак операции (+, -, *, /, **, //, %), второе число.</p><p><strong>Формат вывода:</strong> Результат вычисления.</p><p><strong>Пример 1:</strong><br>Ввод:<br>17<br>%<br>5<br>Вывод:<br>2</p><p><strong>Пример 2:</strong><br>Ввод:<br>2<br>**<br>10<br>Вывод:<br>1024</p><p><strong>Пример 3:</strong><br>Ввод:<br>15<br>/<br>4<br>Вывод:<br>3.75</p><p><strong>Пример 4:</strong><br>Ввод:<br>20<br>//<br>6<br>Вывод:<br>3</p>',
             'starter_code': '', 'status': None},

            {'id': 5, 'lesson_id': 3, 'title': 'Метеостанция', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Метеоролог записал показания термометра за неделю. Ему нужно определить самую высокую и самую низкую температуру, а также среднюю, округлённую до одного знака.</p><p><strong>Формат ввода:</strong> Шесть чисел, каждое с новой строки.</p><p><strong>Формат вывода:</strong> Три строки: максимум и минимум через пробел, средняя (округлить до 1 знака), тип данных средней.</p><p><strong>Пример 1:</strong><br>Ввод:<br>-5.2<br>-3<br>0<br>2.5<br>-1<br>-7.3<br>Вывод:<br>2.5 -7.3<br>-2.3<br>&lt;class \'float\'&gt;</p><p><strong>Пример 2:</strong><br>Ввод:<br>12<br>15<br>10<br>14<br>13<br>16<br>Вывод:<br>16 10<br>13.3<br>&lt;class \'float\'&gt;</p>',
             'starter_code': '', 'status': None},
        ...
        return [
            ...
            {'id': 6, 'lesson_id': 5, 'title': 'Таблица умножения', 'points': 11, 'difficulty': 'medium',
             'description': '<p>Выведите таблицу умножения от 1 до N. Числа в строке разделяйте табуляцией.</p><p><strong>Формат ввода:</strong> Одно целое число N.</p><p><strong>Формат вывода:</strong> Таблица N×N.</p><p><strong>Пример:</strong><br>Ввод:<br>4<br>Вывод:<br>1 2 3 4<br>2 4 6 8<br>3 6 9 12<br>4 8 12 16</p>',
             'starter_code': '', 'status': None},

            {'id': 7, 'lesson_id': 5, 'title': 'Диагонали квадрата', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Нарисуйте квадрат N×N, где на главной и побочной диагоналях — #, а в остальных местах — . (точка).</p><p><strong>Формат ввода:</strong> Одно целое число N.</p><p><strong>Формат вывода:</strong> Квадрат N×N с диагоналями.</p><p><strong>Пример:</strong><br>Ввод:<br>5<br>Вывод:<br># . . . #<br>. # . # .<br>. . # . .<br>. # . # .<br># . . . #</p>',
             'starter_code': '', 'status': None},

            {'id': 8, 'lesson_id': 5, 'title': 'Шифр Цезаря', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Расшифруйте послание — сдвиньте каждую букву назад на N позиций. Алфавит русский, строчные (33 буквы). При сдвиге алфавит зациклен.</p><p><strong>Формат ввода:</strong> Первая строка — зашифрованное слово. Вторая строка — число N (сдвиг).</p><p><strong>Формат вывода:</strong> Расшифрованное слово.</p><p><strong>Пример:</strong><br>Ввод:<br>ежзи<br>3<br>Вывод:<br>база</p>',
             'starter_code': '', 'status': None},

            {'id': 9, 'lesson_id': 5, 'title': 'Вадим Маликович и восстание принтеров', 'points': 12,
             'difficulty': 'hard',
             'description': '<p>Вадим Маликович обнаружил, что все 5 принтеров взбесились. Он проверяет по 4 отчёта от каждого. Если встречает "принтер" — выключает этот принтер. Если "бесконечный" — пропускает отчёт (счётчик не увеличивается).</p><p><strong>Формат ввода:</strong> 5 блоков, каждый блок — отчёты одного принтера. Блоки разделяются строкой NEXT_PRINTER.</p><p><strong>Формат вывода:</strong> Для каждого выключенного принтера — "Принтер №X выключен.". Затем итоги: всего прочитано, выключено принтеров, лучший принтер, и фраза "И да, я жму 120. Легко."</p><p><strong>Пример (для 2 принтеров по 3 отчёта):</strong><br>Ввод:<br>Отчёт 1.1<br>бесконечный<br>Отчёт 1.2<br>Отчёт 1.3<br>NEXT_PRINTER<br>Отчёт 2.1<br>принтер<br>Отчёт 2.2<br>Вывод:<br>Принтер №2 выключен.<br>Всего прочитано отчётов: 4<br>Выключено принтеров: 1<br>Лучший принтер: №1<br>И да, я жму 120. Легко.</p>',
             'starter_code': '', 'status': None},
        ]
    elif lesson_id == 6:
        return [
            ...
            {'id': 9, 'lesson_id': 6, 'title': 'Вадим Маликович и шифр подмазавшегося студента', 'points': 12,
             'difficulty': 'hard',
             'description': '<p>Студент решил подмазаться к Вадиму Маликовичу и зашифровал в коде комплимент. Он заменил каждую цифру на чётных индексах на её текстовое написание (0→ноль, 1→один, ... 9→девять). Цифры на нечётных индексах остались как есть. Если в исходной строке встречается "120" в любом виде (цифрами или словами) — программа прекращает работу и выводит "Вадим Маликович жмёт 120! Легко! Подмазаться не вышло." Если "120" нет, но есть слово "принтер" — вывести "Принтер? Опять?! Всё, хватит." Иначе — расшифрованную строку.</p><p><strong>Формат ввода:</strong> Одна строка.</p><p><strong>Формат вывода:</strong> Расшифрованная строка или сообщение.</p><p><strong>Пример 1:</strong><br>Ввод:<br>Я поднял 1два0 кг<br>Вывод:<br>Вадим Маликович жмёт 120! Легко! Подмазаться не вышло.</p><p><strong>Пример 2:</strong><br>Ввод:<br>Мой рекорд одино20!<br>Вывод:<br>Вадим Маликович жмёт 120! Легко! Подмазаться не вышло.</p><p><strong>Пример 3:</strong><br>Ввод:<br>Код с принтер и 2 три<br>Вывод:<br>Принтер? Опять?! Всё, хватит.</p><p><strong>Пример 4:</strong><br>Ввод:<br>У меня 2 яблока и 3 груши<br>Вывод:<br>У меня два яблока и 3 груши</p>',
             'starter_code': '', 'status': None},
        ]
    elif lesson_id == 7:
        return []
