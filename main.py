    ...
    if lesson_id == 1:
        ...
        return [
            ...
            {'id': 7, 'lesson_id': 5, 'title': 'Диагонали квадрата', 'points': 12, 'difficulty': 'hard',
             'description': '<p>Нарисуйте квадрат N×N, где на главной и побочной диагоналях — #, а в остальных местах — . (точка).</p><p><strong>Формат ввода:</strong> Одно целое число N.</p><p><strong>Формат вывода:</strong> Квадрат N×N с диагоналями. Символы в строке разделены пробелом.</p><p><strong>Пример:</strong><br>Ввод:<br>5<br>Вывод:<br># . . . #<br>. # . # .<br>. . # . .<br>. # . # .<br># . . . #</p>',
             'starter_code': '', 'status': None,
             'tests': [
                 {"input": ['5'], "expected": ['# . . . #', '. # . # .', '. . # . .', '. # . # .', '# . . . #']},
                 {"input": ['3'], "expected": ['# . #', '. # .', '# . #']},
